  ...
  const worlds = [
    {
      ...
      subs: [
        ...
        { label: '灵魂永生', href: 'book-detail.html?id=10-01', desc: 'Seth Speaks' },
        { label: '个人实相的本质', href: 'book-detail.html?id=10-02', desc: 'Personal Reality' },
        { label: '未知的实相 一', href: 'book-detail.html?id=10-03', desc: 'Unknown Reality I' },
        { label: '未知的实相 二', href: 'book-detail.html?id=10-04', desc: 'Unknown Reality II' },
        { label: '心灵的本质', href: 'book-detail.html?id=10-05', desc: 'Nature of the Psyche' },
        { label: '个人与事件的本质', href: 'book-detail.html?id=10-06', desc: 'Nature of Events' },
